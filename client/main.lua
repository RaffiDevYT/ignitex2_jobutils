...
RegisterNUICallback(
    ...
    function(data)
        ...
        TriggerServerEvent("ignitex2_jobutilities:deposit", job, amount)
    end
)
...
RegisterNUICallback(
    ...
    function(data)
        ...
        TriggerServerEvent("ignitex2_jobutilities:withdraw", job, amount)
    end
)
...
RegisterNUICallback(
    ...
    function(data)
        ...
        TriggerServerEvent("ignitex2_jobutilities:hire", id, job)
    end
)
...
RegisterNUICallback(
    ...
    function(data)
        ...
        TriggerServerEvent("ignitex2_jobutilities:fire", identifier, job)
    end
)
...
RegisterNUICallback(
    ...
    function(data)
        ...
        TriggerServerEvent("ignitex2_jobutilities:givebonus", identifier, amount, job)
    end
)
...
RegisterNUICallback(
    ...
    function(data)
        ...
        TriggerServerEvent("ignitex2_jobutilities:setRank", identifier, job, rank)
    end
)
...
RegisterNUICallback(
    "removejob",
    function(data)
        TriggerServerEvent("ignitex2_jobutilities:removeJob", data["job"], data["grade"])
    end
)
...
RegisterNUICallback(
    "addjob",
    function(data)
        TriggerServerEvent("ignitex2_jobutilities:addJob", data["job"])
    end
)
...
RegisterNUICallback(
    "changejob",
    function(data)
        TriggerServerEvent("ignitex2_jobutilities:changeJob", data["job"], data["grade"])
    end
)


RegisterNetEvent("ignitex2_jobutilities:sendMessage")
AddEventHandler(
    "ignitex2_jobutilities:sendMessage",
    function(msg)
        SendTextMessage(msg)
    end
)
