...
$(document).keyup(function(e) {
    if (e.keyCode === 27) {
        ...
        $.post('https://ignitex2_jobutilities/close', JSON.stringify({}));
...
function hireperson(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://ignitex2_jobutilities/hire', JSON.stringify({job: currentBossMenuJob, id: id}));
}
...
function withdrawAmount(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://ignitex2_jobutilities/withdraw', JSON.stringify({job: currentBossMenuJob, amount: amount}));
}
...
function givebonus(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://ignitex2_jobutilities/givebonus', JSON.stringify({identifier: identifier, amount: amount, job: currentBossMenuJob}));
}
...
function depositAmount(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://ignitex2_jobutilities/deposit', JSON.stringify({job: currentBossMenuJob, amount: amount}));
}
...
function fire(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://ignitex2_jobutilities/fire', JSON.stringify({identifier: identifier, job: currentBossMenuJob}));
...
function promote(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://ignitex2_jobutilities/setrank', JSON.stringify({identifier: identifier, rank: rank, job: currentBossMenuJob}));
...
window.addEventListener('message', function(event) {
    ...
    $(".addjob").click(function() {
        ...
        if ($(this).text().replace(/ /g, '') != 'SELECTED') {
            ...
            $(this).text('SELECTED');
            $.post('https://ignitex2_jobutilities/addjob', JSON.stringify({
